					...
					>
						...
						<label class="block">
							...
							<input
								...
								class="mt-2 w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 {(updateCampaign.fields.name.issues()
									?.length ?? 0) > 0
									? 'border-red-500'
									: 'border-gray-300'}"
								placeholder="Enter campaign name"
								value={updateCampaign.fields.name.value() ??
									campaign.name}
						...
						<label class="block">
							...
							<textarea
								...
								rows="12"
								class="mt-2 w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm {(updateCampaign.fields.content.issues()
									?.length ?? 0) > 0
									? 'border-red-500'
									: 'border-gray-300'}"
								placeholder={"{}"}
								value={updateCampaign.fields.content.value() ??
