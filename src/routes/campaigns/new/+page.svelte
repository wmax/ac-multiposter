			...
			>
				<label class="block">
					...
					<input
						...
						class="mt-2 w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 {(createCampaign.fields.name.issues()
							?.length ?? 0) > 0
							? 'border-red-500'
							: 'border-gray-300'}"
				...
				<label class="block">
					...
					<textarea
						...
						rows="12"
						class="mt-2 w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm {(createCampaign.fields.content.issues()
							?.length ?? 0) > 0
							? 'border-red-500'
							: 'border-gray-300'}"
						placeholder={"{}"}
